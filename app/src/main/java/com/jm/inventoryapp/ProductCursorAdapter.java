...
import com.jm.inventoryapp.data.ProductContract;
import com.jm.inventoryapp.data.ProductContract.ProductEntry;
import com.jm.inventoryapp.data.ProductDbHelper;
...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        // that says "Unknown product", so the TextView isn't blank.
        ...
        // Update the quantity of the product when the sale button is clicked from the list view
        ...
        sale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQuantity > 0) {
                    ...
                    Uri bookUri = ContentUris.withAppendedId(ProductEntry.CONTENT_URI, id);
                    ...
                    Toast.makeText(context, "Success: Sold!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(context, "Error: Please reorder!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
