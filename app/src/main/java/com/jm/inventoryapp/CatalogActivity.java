...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertProduct(){
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_NAME, "Product 1");
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER, "Supplier 1");
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE, "312-867-5309");
