...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callButton = (ImageButton) findViewById(R.id.call_supplier);
    ...
    private void saveProduct() {
        ...
        if (mCurrentProductUri == null &&
            ...
            Toast.makeText(this, getString(R.string.editor_cannot_be_null),
                    Toast.LENGTH_SHORT).show();
            //TO-DO : make sure to stay in the activity rather than exiting if values are null
            return;
        }
